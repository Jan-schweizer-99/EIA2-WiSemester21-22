namespace EventInspector {
    ...
    function handleLoad(_event: Event): void {
        ...
        let div0: HTMLElement = document.createElement("div");      //gut nun probieren wir (div0) in Typescript das HTML Element zu erzeugen
        div0.classList.add("box");
        div0.setAttribute("id", "div0");
        document.body.appendChild(div0);

        let div1: HTMLElement = document.createElement("div");      //gut nun probieren wir (div1) in Typescript das HTML Element zu erzeugen
